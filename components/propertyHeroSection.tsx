  ...
  return (
    <div className="w-full mx-auto grid grid-cols-1 md:grid-cols-12 items-center">
      ...
      <div className="col-span-12 lg:col-span-5 h-full">
        <div className="bg-[linear-gradient(to_top,rgba(12,21,55,1)_0%,rgba(12,21,55,0)_50%)] p-10 pb-18 sm:pb-[136px] flex flex-col gap-8 h-full">

          <div className="flex flex-col gap-4">
            <h2 className="text-[44px] sm:text-[48px] font-extrabold text-[#170085]">
              Find The Place To Live
              <span className="text-outline text-[48px]  font-bold mx-3">Your Dreams</span>
              Easily Here
            </h2>
            <p className="text-[#626687] font-normal text-base">
              Everything you need about finding your place to live will be here, where it will be easier for you
            </p>
          </div>

          <div className="bg-white rounded-full shadow  flex p-1 justify-between max-w-[450px]">
            <div className="gap-4 py-3 pl-8 pe-1 flex">
              <Image
              ...
              <input
                ...
                className="flex-1 outline-none text-sm font-medium text-[#888B97]"
              />

            </div>
            <button className="bg-[#170085] text-white pe-3 pl-5 py-2 rounded-full gap-1 flex items-center text-sm font-semibold">
              Search
              <Image
