          ...
          "
            >
              <div className="relative w-full h-44 overflow-hidden group">
                ...
                <div className="absolute top-3 right-3 bg-[#272C35] rounded-full p-1.5 shadow">
                ...
                <div className="absolute bottom-3 right-3 bg-[#FCFCFC] text-[var(--textDark)] text-sm font-normal px-2 py-0.5 rounded-full">
                  1 / 11
                </div>
              </div>
