        ...
        <>
            <div className="container mx-auto ">
                ...
                <div className="pt-11 pb-18 flex flex-col gap-10">
                    <div className="w-11/12 sm:w-8/12 md:w-6/12 lg:w-6/12 m-auto text-center">
                        <h2 className="text-2xl sm:text-[40px] font-bold text-black mb-2">
                            Find Your Dream Home Easily
                        </h2>
                        <p className="text-black font-semibold text-xs sm:text-lg sm:px-14 px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 sm:gap-18 gap-9 px-6 pb-8">
                    ...
                    <div className="md:col-span-5 flex flex-col gap-3.5 justify-center order-1 md:order-none">
                        <div className="flex flex-col md:gap-8 gap-4">
                            <h2 className="text-black text-2xl sm:text-[42px] font-bold">
                                Genuine connections for Free
                            </h2>
                            <h3 className="text-black text-sm sm:text-xl font-semibold">
                ...
                <div className="flex flex-col md:flex-row md:justify-between items-center gap-10 px-6">
                    ...
                    <div className="w-full md:w-5/12">
                        <div className="flex flex-col gap-3.5 ">
                            <div className="flex flex-col md:gap-8 gap-4">
                                <h2 className="text-black text-2xl sm:text-[42px] font-bold sm:pe-10 lg:pe-38 pe-0">
