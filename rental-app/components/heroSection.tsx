    ...
    return (
        ...
        <>
            ...
            <div className="hero-background-img">
                {/* Title */}
                <div className="w-8/12 m-auto flex flex-col gap-3 justify-center items-center pt-6 pb-8">
                    <h1 className="text-4xl xs:text-xl sm:text-3xl md:text-4xl lg:text-[54px]  font-extrabold text-black mb-0 text-center px-4 sm:px-0">
                ...
                <div className="relative w-[38%] mx-auto flex justify-end items-center mt-10">

                    {/* LEFT FLOATING CARD */}
                    <div className=" text-black flex flex-col gap-1.5 py-4 ps-6 pe-9
                        absolute 
                        left-[102px]  
                        z-1
                        top-[148px] 
                        bg-white shadow-xl rounded-2xl w-60
                        floating-left
                    ">
                        <Image
                        ...
                        <h2 className="text-[32px] font-bold">$2,864</h2>
                        <div className="w-[166px] h-1.5 bg-gray-200 rounded-full overflow-hidden">
                            <div className="h-1.5 bg-[#1B1C57] w-[70%] rounded-full"></div>
                        </div>
                    </div>

                    {/* MOBILE IMAGE */}
                    <div className="w-[260px] md:w-[280px] relative z-0 -mb-[24px]">
                        <Image
                    ...
                    {/* RIGHT FLOATING CARD */}
                    <div className=" flex gap-3 text-black py-2 px-3.5
                        absolute 
                        right-[-165px] 
                        bottom-[135px] 
                        bg-white shadow-xl rounded-2xl  w-55
                        floating-right
                        z-1
                    ">
                        <Image
                        ...
                        />
                        <div>
                            <p className="text-xs font-semibold mb-0">Minimum Premium</p>
                            <h2 className="text-[22px] font-semibold mb-0">$2,864/Month</h2>
                        </div>
                    </div>
            ...
            <div className="hero-mobile-view relative">
                ...
                <div className="hero-mobile-img ">
                    <div className="w-[200px] m-auto">
                        ...
                        z-1
                        top-[268px] 
                        bg-white shadow-xl rounded-xl w-30
                        floating-left
                    ">
                            <Image
                                src="/assets/images/svg/checkMark.svg"
                            ...
                            <h2 className="text-sm font-bold">$2,864</h2>
                            <div className="w-[70px] h-1.5 bg-gray-200 rounded-full overflow-hidden">
                                <div className="h-1.5 bg-[#1B1C57] w-[50%] rounded-full"></div>
                            </div>
                        </div>
                        ...
                        right-[12px] 
                        bottom-[75px] 
                        bg-white shadow-xl rounded-xl  w-35
                        floating-right
                        z-1
                    ">
                            <Image
                            ...
                            />
                            <div>
                                <p className="text-[10px] font-semibold mb-0">Minimum Premium</p>
                                <h2 className="text-[12px] font-semibold mb-0">$2,864/Month</h2>
                            </div>
                        </div>
