                        ...
                        <div className="flex justify-center">
                            <Link href="/">
                                <Image
                                    ...
                                    height={130}
                                    alt="Logo"
                                    className="max-w-[142px] max-h-[130px]"
                                />
                            </Link>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col w-full">
                            <div className="flex flex-col gap-[54px]">
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="text-[16px] font-semibold text-[#000000]">
                                        Enter OTP
                                    </label>
                                    <div className="flex gap-[15px] justify-center">
                                        {otp.map((digit, index) => (
                                            <input
                                                ...
                                                className="w-[48px] h-[48px] text-center border-[0.8px] border-[#A6A6A6] rounded-[8px] text-[20px] font-semibold text-[#000000] bg-[#FFFFFF] focus:outline-none focus:border-transparent focus:bg-[#F1F1FE] focus:shadow-lg transition-all duration-300"
                                                style={{
                                    ...
                                    <div className="flex justify-end mt-2">
                                        {canResend ? (
                                            <button
                                                ...
                                                className="text-[14px] font-normal text-[#170085] hover:underline cursor-pointer"
                                            >
                                                Resend OTP
                                            </button>
                                        ) : (
